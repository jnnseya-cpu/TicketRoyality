  ...
  ({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
    ...
    return (
      <Button
        ...
        variant={variant}
        size={size}
        className={cn('absolute left-4 top-1/2 h-10 w-10 -translate-y-1/2 rounded-full bg-background/70 backdrop-blur', className)}
  ...
  ({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
    ...
    return (
      <Button
        ...
        variant={variant}
        size={size}
        className={cn('absolute right-4 top-1/2 h-10 w-10 -translate-y-1/2 rounded-full bg-background/70 backdrop-blur', className)}
