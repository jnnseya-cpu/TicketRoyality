...
const NAV = [
  ...
  { href: '/dashboard/organiser/box-office', label: 'Box office', icon: Store },
  ...
  { href: '/dashboard/organiser/analytics', label: 'Analytics', icon: LineChart },
  ...
  { href: '/dashboard/organiser/giving', label: 'Donations & Gift Aid', icon: HeartHandshake },
