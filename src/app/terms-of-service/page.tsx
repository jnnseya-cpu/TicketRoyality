...
const SECTIONS: Array<{ heading: string; paragraphs: string[] }> = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `On our standard plan we deduct no commission from your ticket sales. You receive 100% of the face value of every ticket, subject only to refunds, chargebacks, taxes and any deduction required by law. Our revenue is a TicketRoyality Service Fee paid by the ticket buyer — ${UK_FEES.buyerServicePct}% plus ${formatCurrency(UK_FEES.buyerFixedFeeMinor / 100)} per paid ticket, minimum ${formatCurrency((UK_FEES.minimumServiceFeeMinor ?? 0) / 100)}, VAT included — which is shown inside the total price wherever a ticket is advertised and is never added at checkout. Free tickets carry no fee to anyone.`,
      'If you are on a white-label plan, agreed with us separately, a different fee model applies: you sell under your own brand, set your own booking fee to your buyers, and TicketRoyality charges you a percentage of face value per paid ticket subject to a minimum, with card-processing costs borne by you. The figures for your white-label plan are set out when it is enabled and prevail over the standard fee above; free tickets still carry no platform fee.',
