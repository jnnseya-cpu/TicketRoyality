...
const SEGMENTS = [
  ...
  },
  {
    ...
    next: 'Renew a pass into next season with a holder-first window — last season’s holders buy before general sale, enforced at checkout against who actually bought. Seat-for-seat carry within a seated map is the remaining nuance.',
  },
  {
    icon: Presentation,
    name: 'Conferences',
    ...
    next: 'Speaker portals are not built. The stream is gated at the door — we cannot stop a ticket holder forwarding the link, which would need a streaming provider we do not use.',
  },
  {
    icon: Wine,
    name: 'Nightclubs',
